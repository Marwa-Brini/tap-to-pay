...
import 'package:inst_pay/controller/payment_controller.dart';
import 'package:inst_pay/view/screen/Transaction/request_screen.dart';
import 'package:inst_pay/view/screen/Transaction/send_screen.dart';
              ...
              builder:
                  (_) => AlertDialog(
                    ...
                    actions: [
                      ...
                      TextButton(
                        onPressed: () async {
                          final BankAccountController controller = Get.find();
                          await controller.deleteBankAccounts(
                            widget.bankAccountModel.id!,
                          );
                          Navigator.of(context).pop();
                        },
                        child: Text('delete'),
